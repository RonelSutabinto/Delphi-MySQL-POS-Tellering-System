object quehistoryFrm: TquehistoryFrm
  Left = 0
  Top = 0
  BorderStyle = bsNone
  Caption = 'quehistoryFrm'
  ClientHeight = 611
  ClientWidth = 373
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object number_lb2: TAdvSmoothLabel
      ...
      CaptionShadow.Text = 'Caller History  s'
  ...
  object manageOutQ: TMyQuery
    ...
    SQL.Strings = (
        ...
        'Select m.*,concat(type,number) qNumber from manageout m where da' +
        'te = :date order by entry desc')
    Left = 168
    Top = 120
    ParamData = <
      item
    ...
    object manageOutQqNumber: TStringField
      FieldName = 'qNumber'
      Size = 15
    end
  end
